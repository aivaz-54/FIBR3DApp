...
namespace lhslib
{
     ...
     *
     */
    void optSeededLHS(int n, int k, int maxSweeps, double eps, bclib::matrixlhs<double> & oldHypercube,
                      int optimalityRecordLength, bool bVerbose)
    {
        ...
        bclib::matrixlhs<double> newHypercube = bclib::matrixlhs<double>(nsamples, nparameters);

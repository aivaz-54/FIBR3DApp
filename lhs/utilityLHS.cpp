...
namespace lhslib
{
    ...
    bool isValidLHS(const bclib::matrixlhs<double> & result)
    {
        ...
        bclib::matrixlhs<int> resultint = bclib::matrixlhs<int>(n, k);
        bclib::matrixlhs<double>::const_iterator it = result.begin();
        bclib::matrixlhs<int>::iterator iti = resultint.begin();

...
namespace lhslib
{
    void improvedLHS(int n, int k, int dup, bclib::matrixlhs<int> & result, bclib::CRandom<double> & oRandom)
    {
        if (n < 1 || k < 1 || dup < 1)
        {
        ...
        bclib::matrixlhs<int> avail = bclib::matrixlhs<int>(nparameters, nsamples);
        bclib::matrixlhs<int> point1 = bclib::matrixlhs<int>(nparameters, len);
